...
// 특수반 색상 옵션
export const SPECIAL_TEAM_COLORS = [
...
// 특수반 상태 옵션
export const SPECIAL_TEAM_STATUS_OPTIONS = [
  { value: "all", label: "전체" },
...
// 기본 특수반 설정
export const DEFAULT_SPECIAL_TEAMS = [
  {
    id: "1",
    name: "특수반 1",
    color: "bg-blue-500",
...
// 특수반 관리 UI 텍스트
export const SPECIAL_TEAM_UI_TEXT = {
  pageTitle: "특수반 관리",
  buttons: {
    setting: "특수반 설정",
    addCaddie: "캐디 추가",
...
// 특수반 관리 폼 검증 규칙
export const SPECIAL_TEAM_FORM_VALIDATION = {
  teamName: {
...
// 특수반 관리 테이블 설정
export const SPECIAL_TEAM_TABLE_CONFIG = {
  itemsPerPage: 10,
  showPagination: true,
  showSearch: true,
  showFilters: true,
